...
export class GameUtil {
     ...
     * @param mark マーク
     */
    public static simulateAdvance(simulate: SimulateService, mark: MarkType, coord: Coord): void {
     ...
     * @param mark マーク
     */
    private static advanceMap(mapState: MapState, coord: Coord, mark: MarkType): void {
